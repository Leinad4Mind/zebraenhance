...
$lang = array_merge($lang, array(
	...
	'ACP_ZE_MAX_PENDING_REQUESTS_EXPLAIN' => 'Máximo de solicitações recebidas e enviadas por usuário, aplicado separadamente a cada direção. Use 0 para não limitar.',
	...
	'ACP_ZE_FOES_ENHANCEMENT' => 'Ativar melhorias para inimigos',
	'ACP_ZE_FOES_ENHANCEMENT_EXPLAIN' => 'Disponibiliza o gestor melhorado de inimigos e as proteções selecionadas abaixo. Quando desativada, permanece apenas o comportamento nativo do phpBB.',
	'ACP_ZE_FOE_PM' => 'Proteção de mensagens privadas',
	'ACP_ZE_FOE_PM_EXPLAIN' => 'Permite que os usuários rejeitem mensagens privadas enviadas pelos seus inimigos.',
	'ACP_ZE_FOE_CONTENT' => 'Ocultação de conteúdo e citações',
	'ACP_ZE_FOE_CONTENT_EXPLAIN' => 'Permite ocultar mensagens, resultados de pesquisa e citações identificáveis dos inimigos.',
	'ACP_ZE_FOE_NOTIFICATIONS' => 'Silenciar notificações',
	'ACP_ZE_FOE_NOTIFICATIONS_EXPLAIN' => 'Permite suprimir notificações compatíveis geradas pelos inimigos.',
	'ACP_ZE_FOE_TEMPORARY' => 'Inimigos temporários',
	'ACP_ZE_FOE_TEMPORARY_EXPLAIN' => 'Permite que relações de inimigo expirem após 24 horas, 7 dias ou 30 dias.',
	'ACP_ZE_FOE_NOTES' => 'Notas privadas sobre inimigos',
	'ACP_ZE_FOE_NOTES_EXPLAIN' => 'Permite guardar uma nota privada para cada inimigo.',
	'ACP_ZE_FOE_EXCEPTIONS' => 'Exceções por inimigo',
	'ACP_ZE_FOE_EXCEPTIONS_EXPLAIN' => 'Permite substituir as escolhas globais de mensagens privadas, conteúdo e notificações para inimigos individuais.',
