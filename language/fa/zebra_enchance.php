...
$lang = array_merge($lang, array(
	...
	'ZEBRAENHANCE_FRIENDLIST'	=>	'لیست دوستان',
	'ZEBRAENHANCE_FRIENDLIST_EXPLAIN'	=>	'چه کسی لیست دوستان شما را ببیند؟',
	'FRIENDLIST_ERROR_ACCESS'	=>	'شما دسترسی برای دیدن لیست دوستان را ندارید.',
	'FRIENDLIST_TITLE'       => 'لیست دوستان',
	...
	'ZEBRAENHANCE_REQUEST_POLICY'                    => 'چه کسانی می‌توانند برای شما درخواست دوستی بفرستند؟',
	'ZEBRAENHANCE_REQUEST_POLICY_EXPLAIN'            => 'این گزینه فقط برای درخواست‌های جدید است. درخواست‌هایی که قبلاً فرستاده‌اید همچنان قابل پذیرش هستند.',
	'ZEBRAENHANCE_REQUEST_POLICY_EVERYONE'           => 'همه',
	'ZEBRAENHANCE_REQUEST_POLICY_FRIENDS_OF_FRIENDS' => 'دوستان دوستان',
	'ZEBRAENHANCE_REQUEST_POLICY_NOBODY'             => 'هیچ‌کس',
	'ZEBRAENHANCE_REQUEST_MESSAGE'                   => 'پیام اختیاری',
	'ZEBRAENHANCE_REQUEST_MESSAGE_PLACEHOLDER'       => 'یک پیام شخصی کوتاه اضافه کنید (اختیاری)',
